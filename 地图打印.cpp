/* 
   更新:添加player越界检测 更新:将检测移动到int mov(char c)
   预备更新:修改map_printf()->switch为数组

 */



/* 错误列表: main: 0-未知 1-无错误 2-正常退出 3-player越界
   mov(int): 0-错误 1-无错误 mov(char): 0-错误 1-无错误 3-越界
...
{
	/* char
	   a[16]={232,128,129,229,184,136,230,152,175,230,178,153,233,155,149};
	   cout << "Hello,World!" << a << "\n"; cin >> a[9] >> a[10] >> a[11] >>
	   a[12] >> a[13] >> a[14]; cout << a << "\n"; */
	hello();
	char c;
